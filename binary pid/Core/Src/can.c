...
/* USER CODE BEGIN 0 */
//ºê¶¨Òå»ñÈ¡µç»úid ´¦Àíµç»úÊı¾İ -- ½Ç¶È£¬ËÙ¶ÈµÈ
...
motor_measure_t motor_chassis[7]; //½á¹¹ÌåÀàĞÍÏÂµÄÊı×é
...
void CAN_cmd_chassis(int16_t motor1, int16_t motor2, int16_t motor3, int16_t motor4)
{
	...
	chassis_tx_message.DLC = 0x08;  //Ò»¸ö±ê×¼
	//¿ªÊ¼Æ´½Ó¸ßµÍ°ËÎ»
...
{
  gamble_tx_message.StdId = 0x2ff;//(id_range == 0)?(0x1ff):(0x2ff); //0x2ff  -- 3¸öµç»ú¿ØÖÆ(·ÇÁã)
  ...
  gamble_can_send_data[1] =    (v1)&0xff;  //»ñÈ¡µÍ°ËÎ»
...
//½ÓÏÂÀ´ÎÒÃÇĞèÒªĞ´½ÓÊÕÁ÷³ÌÀûÓÃRX0µÄÖĞ¶Ï
//hal_can.cµÄ1907ĞĞµÄÈõ¶¨Òåº¯ÊıÔÚÕâÀï½øĞĞ¶¨Òå
...
//ÒòÎªÒª¶ÁÈ¡µç»úËÙ¶È£¬ËùÒÔĞèÒª½øĞĞ¶ÁÈ¡Êı¾İÂï
