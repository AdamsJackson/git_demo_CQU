...
void MX_CAN1_Init(void)
{
  ...
  /* USER CODE BEGIN CAN1_Init 2 */
    ...
    CAN_FilterTypeDef can_filter_st;                   //³õÊ¼»¯can1¹ýÂËÆ÷£»
    can_filter_st.FilterActivation = ENABLE;           //enable ÆôÓÃ¹ýÂËÆ÷
    can_filter_st.FilterMode = CAN_FILTERMODE_IDMASK;  //Mode¼´±íÊ¾¹ýÂËÆ÷µÄÄ£Ê½Îª±êÊ¶·ûÆÁ±Î×´Ì¬
    ...
    can_filter_st.FilterBank = 0;                      //¹ýÂËÆ÷×é±àºÅ
    can_filter_st.FilterFIFOAssignment = CAN_RX_FIFO0; //½á¹û´æ´¢£¨RX-½ÓÊÕ£FFIFOO©
    HAL_CAN_ConfigFilter(&hcan1, &can_filter_st);      //¶Ô¹ýÂËÆ÷ÅäÖÃ
